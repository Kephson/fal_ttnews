...
$tc['tx_falttnews_fal_images']['label'] = 'LLL:EXT:fal_ttnews/Resources/Private/Language/locallang.xlf:tt_news.tx_falttnews_fal_images';

$tempSetup = unserialize($GLOBALS['TYPO3_CONF_VARS']['EXT']['extConf']['fal_ttnews']);
...
if ($tempSetup['media_add_ref']) {
	if ($tempSetup['media_add_orig_field']) {
		...
		$GLOBALS['TCA']['tt_news']['types']['0']['showitem'] = str_replace('image;', ' tx_falttnews_fal_images;', $GLOBALS['TCA']['tt_news']['types']['0']['showitem']);
		$GLOBALS['TCA']['tt_news']['types']['1']['showitem'] = str_replace('image;', ' tx_falttnews_fal_images;', $GLOBALS['TCA']['tt_news']['types']['1']['showitem']);
		$GLOBALS['TCA']['tt_news']['types']['2']['showitem'] = str_replace('image;', ' tx_falttnews_fal_images;', $GLOBALS['TCA']['tt_news']['types']['2']['showitem']);
	}
}
...
$tc_el['tx_falttnews_fal_media']['label'] = 'LLL:EXT:fal_ttnews/Resources/Private/Language/locallang.xlf:tt_news.tx_falttnews_fal_media';
...
if ($tempSetup['media_add_ref']) {
	if ($tempSetup['media_add_orig_field']) {
		...
		$GLOBALS['TCA']['tt_news']['types']['0']['showitem'] = str_replace('news_files;', ' tx_falttnews_fal_media;', $GLOBALS['TCA']['tt_news']['types']['0']['showitem']);
		$GLOBALS['TCA']['tt_news']['types']['1']['showitem'] = str_replace('news_files;', ' tx_falttnews_fal_media;', $GLOBALS['TCA']['tt_news']['types']['1']['showitem']);
		$GLOBALS['TCA']['tt_news']['types']['2']['showitem'] = str_replace('news_files;', ' tx_falttnews_fal_media;', $GLOBALS['TCA']['tt_news']['types']['2']['showitem']);
	}
}
